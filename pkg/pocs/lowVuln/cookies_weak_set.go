...
func Cookies_not_set_secure_flag(args *plugin.GroupData) (*util.ScanResult, bool, error) {
...
func (c *ClassSomething) startTesting123() bool {
	///先请求一次
	...
	if len(cookies) == 0 {
		return false
	} else if !funk.Contains(strings.ToLower(string(cookies)), strings.ToLower("Secure")) {
